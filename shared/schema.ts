...
export const markets = pgTable("markets", {
  ...
  // Contract addresses — per-market (set after Factory deployment)
  contractVault: text("contract_vault"),
  contractPerps: text("contract_perps"),
  // Shared platform contracts stored in env, not per-market:
  // Oracle, Funding, Factory are all shared and not stored here
  contractOracle: text("contract_oracle"),      // deprecated — kept for compat
  contractFunding: text("contract_funding"),    // deprecated — kept for compat
  contractLiquidation: text("contract_liquidation"), // deprecated — kept for compat
  contractInsurance: text("contract_insurance"), // deprecated — kept for compat

  // Per-market dedicated bot wallet (generated by platform when market is created)
  marketBotWallet: text("market_bot_wallet"),
  marketBotPrivkey: text("market_bot_privkey"), // encrypted private key stored server-side
